...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { author_id: @playlist.author_id, description: @playlist.description, name: @playlist.name } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { author_id: @playlist.author_id, description: @playlist.description, name: @playlist.name } }
